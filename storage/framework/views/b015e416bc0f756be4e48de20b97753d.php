<footer class="border-t border-slate-200 bg-white">
    <div class="mx-auto max-w-7xl px-4 py-12 md:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            <div class="space-y-3">
                <?php echo $__env->make('site.partials.logo', ['onDark' => false, 'class' => 'items-start'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            <div>
                <h3 class="mb-3 text-lg font-bold text-slate-900">Önemli</h3>
                <ul class="space-y-2 text-sm text-slate-800 font-medium">
                    <li><a href="<?php echo e(route('about')); ?>" class="hover:text-uid-navy">Hakkımızda</a></li>
                    <li><a href="<?php echo e(route('membership.create')); ?>" class="hover:text-uid-navy">Üye ol</a></li>
                    <li><a href="<?php echo e(route('news.index')); ?>" class="hover:text-uid-navy">Haberler</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="hover:text-uid-navy">İletişim</a></li>
                </ul>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="flex items-center gap-4 text-uid-navy">
                    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" class="hover:text-uid-blue transition" aria-label="X (Twitter)">
                    ...
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" class="hover:text-uid-blue transition" aria-label="Instagram">
                    ...
                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" class="hover:text-uid-blue transition" aria-label="Facebook">
        ...
        <div class="mt-10 border-t border-slate-200 pt-6">
            <div class="flex flex-col items-center justify-between gap-4 text-xs text-slate-500 sm:flex-row">
                <p>© <?php echo e(date('Y')); ?> Union of International Democrats</p>
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="#" class="hover:text-uid-navy">Yasal bildirim</a>
                    <a href="<?php echo e(route('legal.kvkk')); ?>" class="hover:text-uid-navy">Veri koruması</a>
...
<?php /**PATH C:\apps\uid\resources\views/site/partials/footer.blade.php ENDPATH**/ ?>