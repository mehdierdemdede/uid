        ...
        <div class="relative z-10 mx-auto flex min-h-[560px] max-w-7xl flex-col justify-center px-4 py-16 md:min-h-[680px] md:px-8 lg:px-10">
            <div class="max-w-3xl space-y-6 text-white">
                ...
                <div class="flex flex-wrap gap-3 pt-2">
                    <a href="{{ route('news.index') }}" class="inline-flex items-center gap-2 rounded-md bg-white px-5 py-3 text-sm font-semibold text-slate-800 shadow-sm transition hover:bg-slate-100">
                        Haberler
                        <span aria-hidden="true">&gt;</span>
                    </a>
                    <a href="{{ route('membership.create') }}" class="inline-flex items-center gap-2 rounded-md bg-uid-blue px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-uid-blue/90">
                        Üye ol
                        <span aria-hidden="true">&gt;</span>
                    </a>
                </div>
