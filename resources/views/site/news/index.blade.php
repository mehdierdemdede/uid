...
@section('title', __('Haberler').' — UID Bosna Hersek')

@section('content')
<div class="bg-slate-50 py-16 md:py-24">
    <div class="mx-auto max-w-6xl px-4 md:px-8">
        <h1 class="mb-10 text-3xl font-bold text-uid-navy md:text-5xl">{{ __('Haberler ve Duyurular') }}</h1>
        ...
        <div class="space-y-6">
            ...
            @empty
                <div class="rounded-xl border border-slate-200 bg-white p-10 text-center">
                    <p class="text-lg text-slate-500">{{ __('Henüz yayınlanmış bir haber bulunmuyor.') }}</p>
                </div>
            @endforelse
        </div>
